...
//                    consumerModel.getMethodModel(methodConfig.getName()).addAttribute(ASYNC_KEY, asyncMethodInfo);
    ...
    private T createProxy(Map<String, String> map) {
        if (shouldJvmRefer(map)) {
            ...
            if (urls.size() == 1) {
                //服务调用者的invoke，客户端与服务端通信通过invoke<br>
                ...
                if (registryURL != null) { // registry url is available
                    ...
                    //为什么这个地方是静态的因为是配置好了的在application.properties
                    ...
                    String cluster = CollectionUtils.isNotEmpty(invokers)
                            ...
                            : Cluster.DEFAULT;
                    //为什么注册的staticDirectory因为注册的地址是写好了的，注册中心的invokes| 还有一个是服务调用的invokes
                    //包装起来的invoke
        ...
        // create service proxy  --> 这里默认是javaassistInvoke，通过下面语句 @DubboRefrence 返回的是代理类，那么调用的是
